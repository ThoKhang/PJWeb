...
(
	...
	idSanPham char(5) not null foreign key references SanPham(idSanPham)
		...
		on 
			update cascade,
	primary key (idChiTietGioHang, idSanPham),
	soLuongTrongGio int
)
--========================================Ràng buộc=======================================-
...
-- CPU
('SP01', 'CT01', 'LSP01', N'CPU_12400F_1.png', 'CPU_12400F_1.png', 4300000, 
...
('SP06', 'CT04', 'LSP02', N'MSI B660 Tomahawk', 'MAIN_B660_1.png', 4900000, 
...
('SP09', 'CT06', 'LSP03', N'Corsair Vengeance LPX 16GB DDR4 3600', 'RAM_corsairN_1.jpg', 1150000, 
N'Corsair Vengeance LPX 16GB DDR4 3600 được thiết kế để ép xung tối đa, tản nhiệt nhôm cao cấp, đảm bảo tốc độ và độ bền vượt trội cho hệ thống.', N'["RAM_corsairN_1.jpg", "RAM_corsairN_2.jpg", "RAM_corsairN_3.jpg", "RAM_corsairN_4.jpg"]', 55, 15),
('SP10', 'CT06', 'LSP03', N'Corsair Vengeance RGB 32GB DDR5 5600', 'RAM_corsair_3.png', 3200000, 
N'Dòng RAM DDR5 cao cấp với dải đèn RGB rực rỡ, tốc độ siêu nhanh 5600MHz, mang lại hiệu năng đỉnh cao cho các dàn máy chơi game hiện đại.', N'["RAM_corsair_1.png", "RAM_corsair_2.png", "RAM_corsair_3.png", "RAM_corsair_4.png"]', 25, 10),

-- SSD / HDD
('SP11', 'CT08', 'LSP04', N'Kingston NV2 1TB NVMe SSD', 'SSD_KT1T_1.jpg', 1600000, 
N'SSD Kingston NV2 1TB sử dụng chuẩn NVMe Gen4 tốc độ cao, mang đến khả năng khởi động và tải ứng dụng cực nhanh, tiết kiệm điện năng và bền bỉ.', N'["SSD_KT1T_1.jpg", "SSD_KT1T_2.jpg", "SSD_KT1T_3.png", "SSD_KT1T_4.jpeg"]', 70, 25),
('SP12', 'CT06', 'LSP04', N'Corsair MP600 1TB NVMe SSD', 'SSD_Corsair_MP600_1TB_NVMe_SSD.jpg', 2500000, 
N'Corsair MP600 1TB là dòng SSD PCIe Gen4 hiệu suất cực cao, đạt tốc độ đọc ghi lên đến 4950MB/s, phù hợp cho dân chơi PC hiệu năng.', N'["SSD_CS1T_1.jpg", "SSD_CS1T_2.jpg", "SSD_CS1T_3.jpg", "SSD_CS1T_4.jpg"]', 30, 10),
('SP13', 'CT05', 'LSP04', N'Gigabyte 2TB HDD 7200rpm', 'HDD_WD2T_1.jpg', 1400000, 
N'Ổ cứng HDD Gigabyte 2TB tốc độ 7200 vòng/phút, cung cấp dung lượng lưu trữ lớn, độ bền cao, thích hợp cho việc lưu trữ dữ liệu lâu dài.', N'["HDD_WD2T_1.jpg", "HDD_WD2T_2.jpg", "HDD_WD2T_3.jpeg", "HDD_WD2T_4.jpg"]', 45, 15),
-- GPU
...
-- PSU
('SP17', 'CT07', 'LSP06', N'Cooler Master MWE 650W 80+ Bronze', 'PSU_650w_3.png', 1300000, 
N'Cooler Master MWE 650W đạt chứng nhận 80+ Bronze, hiệu suất ổn định, hoạt động êm ái và an toàn cho toàn bộ hệ thống.', N'["PSU_650w_1.png", "PSU_650w_2.png", "PSU_650w_3.png", "PSU_650w_4.png"]', 40, 15),
('SP18', 'CT06', 'LSP06', N'Corsair RM750x 750W 80+ Gold', 'PSU_Corsair_RM750x_750W_80+_Gold.jpg', 2600000, 
N'Corsair RM750x 750W cung cấp công suất ổn định, hiệu suất cao 80+ Gold, dây cáp bọc lưới mềm, hoạt động yên tĩnh với quạt Zero RPM.', N'["PSU_Corsair_RM750x_750W_80+_Gold.jpg", "PSU_650w_2.png", "PSU_Corsair_RM750x_750W_80+_Gold.jpg", "PSU_750w_4.png"]', 20, 5),
...
('SP20', 'CT03', 'LSP07', N'ASUS TUF Gaming GT301', 'CASE_tuf_1.jpg', 
...
4700000, N'MSI G2712FDE mang đến trải nghiệm hình ảnh sống động, tấm nền IPS cao cấp và tần số quét 180Hz cực nhanh.', N'["MHINH_MSI_1.png", "MHINH_MSI_2.png", "MHINH_MSI_3.png", "MHINH_MSI_4.png"]', 35, 10),
...
INSERT INTO DonDatHang (idDonDat, sdtGiaoHang, soNha, trangThai, thanhToan, ngayDat, ngayThanhToan, ngayGiaoDuKien) VALUES
('DH001', '0912345678', N'12 Hàng Bạc', N'Đang giao', N'Đã thanh toán', '2025-09-01', '2025-09-02', '2025-09-05'),
('DH002', '0898765432', N'34 Hàng Buồm', N'Đã giao', N'Đã thanh toán', '2025-09-02', '2025-09-03', '2025-09-06'),
('DH003', '0913344556', N'56 Bến Nghé', N'Đang giao', N'Chưa thanh toán', '2025-09-04', NULL, '2025-09-08'),
('DH004', '0822233345', N'78 Bến Thành', N'Đã giao', N'Đã thanh toán', '2025-08-30', '2025-09-01', '2025-09-04'),
('DH005', '0933344455', N'23 An Biên', N'Đang giao', N'Đã thanh toán', '2025-09-05', '2025-09-05', '2025-09-09'),
('DH006', '0834455667', N'45 An Dương', N'Đã hủy', N'Chưa thanh toán', '2025-09-06', NULL, '2025-09-10'),
('DH007', '0915566778', N'12 An Hòa', N'Đang giao', N'Đã thanh toán', '2025-09-07', '2025-09-08', '2025-09-12'),
('DH008', '0891122334', N'34 An Nghiệp', N'Đã giao', N'Đã thanh toán', '2025-09-01', '2025-09-01', '2025-09-03'),
('DH009', '0912233445', N'12 Hải Châu I', N'Đang giao', N'Đã thanh toán', '2025-09-08', '2025-09-09', '2025-09-13'),
('DH010', '0891122335', N'34 Hải Châu I', N'Đã giao', N'Đã thanh toán', '2025-08-28', '2025-08-29', '2025-09-02'),
('DH011', '0919988777', N'56 Hải Châu II', N'Đang giao', N'Chưa thanh toán', '2025-09-09', NULL, '2025-09-14'),
('DH012', '0812345679', N'78 Hải Châu II', N'Đã giao', N'Đã thanh toán', '2025-08-25', '2025-08-26', '2025-08-30'),
('DH013', '0922233345', N'23 Bình Hiên', N'Đang giao', N'Đã thanh toán', '2025-09-10', '2025-09-11', '2025-09-15'),
('DH014', '0834455668', N'45 Bình Hiên', N'Đã giao', N'Đã thanh toán', '2025-09-03', '2025-09-04', '2025-09-07'),
('DH015', '0912345567', N'12 An Khê', N'Đang giao', N'Đã thanh toán', '2025-09-11', '2025-09-11', '2025-09-16'),
('DH016', '0892345567', N'34 An Khê', N'Đã hủy', N'Chưa thanh toán', '2025-09-07', NULL, '2025-09-18'),
('DH017', '0913344557', N'56 Chính Gián', N'Đang giao', N'Đã thanh toán', '2025-09-02', '2025-09-02', '2025-09-19'),
('DH018', '0823344557', N'78 Chính Gián', N'Đã giao', N'Đã thanh toán', '2025-09-04', '2025-09-05', '2025-09-09'),
('DH019', '0912233445', N'12 Hải Châu I', N'Đang giao', N'Đã thanh toán', '2025-09-10', '2025-09-11', '2025-09-15'),
('DH020', '0891122335', N'34 Hải Châu I', N'Đã giao', N'Đã thanh toán', '2025-09-07', '2025-09-08', '2025-09-12');
...
INSERT INTO ChiTietGioHang (idChiTietGioHang, idSanPham, soLuongTrongGio) VALUES
('GH001', 'SP01', 1),
('GH002', 'SP08', 2),
('GH003', 'SP03', 1),
('GH004', 'SP05', 1),
