    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    _logger.LogInformation("Bạn đã tạo tài khoản với mật khẩu");
                    ...
                    HttpContext.Session.SetString("OTP_EXPIRE",
                        DateTime.Now.AddMinutes(5).ToString("yyyy-MM-dd HH:mm:ss"));

                    // 3. Gửi OTP qua email
                    await _emailSender.SendEmailAsync(user.Email,"Mã xác thực OTP",$"<p>Mã OTP của bạn là: <b>{otp}</b></p><p>OTP có hiệu lực trong 5 phút.</p>");
